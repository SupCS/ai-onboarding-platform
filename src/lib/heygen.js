...
export function buildTeacherVideoPrompt(lesson) {
  ...
  return [
    ...
    'You may add a small number of tasteful on-screen visual elements such as short labels, title cards, lower thirds, icons, or simple explainer graphics when they improve clarity.',
    'When the avatar is speaking on screen, keep overlays minimal and never place text, icons, cards, or graphics over the presenter face.',
    'Do not overcrowd the speaking-avatar shots. Keep the avatar face and upper body clearly visible.',
    'You may use separate cutaway scenes without the avatar for diagrams, process flows, simple animations, or media-style inserts when they help explain the topic.',
